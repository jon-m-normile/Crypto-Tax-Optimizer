...
<style>
    ...
    @keyframes st-sport-cycle {
        0%, 19.9%   { background-image: url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg' fill='%234a9eff'%3E%3Ccircle cx='70' cy='18' r='7'/%3E%3Cpath d='M62 28 L58 50 L48 70 L52 72 L60 55 L64 55 L56 75 L60 77 L70 55 L72 28Z'/%3E%3Cline x1='75' y1='30' x2='95' y2='20' stroke='%234a9eff' stroke-width='2.5'/%3E%3Cpath d='M60 35 L30 25 L5 32 L5 28 L30 21 L60 31Z'/%3E%3C/svg%3E"); }
        20%, 39.9%  { background-image: url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg' fill='%234a9eff'%3E%3Ccircle cx='55' cy='15' r='6'/%3E%3Cpath d='M48 24 L44 42 L38 42 L42 52 L48 48 L52 42 L58 42 L62 52 L68 48 L64 42 L60 42 L56 24Z'/%3E%3Cpath d='M25 55 Q20 50 22 45 Q26 38 35 42 L45 48 L55 48 L65 42 Q74 38 78 45 Q80 50 75 55 L70 65 L75 80 L72 82 L65 68 L60 60 L40 60 L35 68 L28 82 L25 80 L30 65Z'/%3E%3Cpath d='M22 45 L15 42 L10 45' fill='none' stroke='%234a9eff' stroke-width='2'/%3E%3C/svg%3E"); }
        40%, 59.9%  { background-image: url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg' fill='%234a9eff'%3E%3Ccircle cx='45' cy='22' r='7'/%3E%3Cpath d='M38 32 L35 55 L28 75 L33 77 L38 60 L42 55 L44 75 L49 75 L48 55 L52 32Z'/%3E%3Cpath d='M52 35 L62 33 L78 33 L80 36 L78 39 L70 39 L70 48 L66 48 L66 39 L62 39Z'/%3E%3Ccircle cx='90' cy='36' r='5' fill='none' stroke='%234a9eff' stroke-width='1.5'/%3E%3Ccircle cx='90' cy='36' r='2'/%3E%3C/svg%3E"); }
        60%, 79.9%  { background-image: url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg' fill='%234a9eff'%3E%3Ccircle cx='22' cy='42' r='6'/%3E%3Cpath d='M30 42 L75 35 L90 30 L92 34 L78 38 L75 42 L30 48Z'/%3E%3Cpath d='M40 48 L38 58 L32 55' fill='none' stroke='%234a9eff' stroke-width='3' stroke-linecap='round'/%3E%3Cpath d='M55 46 L52 56 L46 54' fill='none' stroke='%234a9eff' stroke-width='3' stroke-linecap='round'/%3E%3Cpath d='M5 65 Q15 58 25 65 Q35 72 45 65 Q55 58 65 65 Q75 72 85 65 Q95 58 100 62' fill='none' stroke='%234a9eff' stroke-width='2' opacity='0.4'/%3E%3Cpath d='M5 75 Q15 68 25 75 Q35 82 45 75 Q55 68 65 75 Q75 82 85 75 Q95 68 100 72' fill='none' stroke='%234a9eff' stroke-width='2' opacity='0.25'/%3E%3C/svg%3E"); }
        80%, 100%   { background-image: url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg' fill='%234a9eff'%3E%3Ccircle cx='58' cy='15' r='7'/%3E%3Cpath d='M52 25 L45 45 L30 55 L34 58 L48 50 L52 45 L56 50 L48 70 L35 85 L40 87 L52 73 L58 60 L64 73 L72 87 L77 85 L68 70 L60 50 L64 25Z'/%3E%3Cpath d='M50 30 L35 28 L25 35 L28 38 L36 32 L50 35Z'/%3E%3Cpath d='M60 30 L72 35 L80 32' fill='none' stroke='%234a9eff' stroke-width='2.5' stroke-linecap='round'/%3E%3C/svg%3E"); }
    }
</style>
